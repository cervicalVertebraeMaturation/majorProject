...
scaler = joblib.load('src/randomforest/randomforestscaler.pkl')
model = joblib.load('src/randomforest/randomforestregressor.pkl')
...
new_features_df.insert(0, 'Model Name', "Random_Forest_Regressor")
