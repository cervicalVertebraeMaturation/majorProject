...
new_image_path = "boneimg/0056041.png"  # Update with your image path
...
scaler = joblib.load('src/gradientboosting/gb_scaler.pkl')
model = joblib.load('src/gradientboosting/gb_regressor.pkl')
...
new_features_df.insert(0, 'Model Name', "Gradient_Boosting")
