...
from sklearn.impute import SimpleImputer  # Handling NaN values
import numpy as np
...
joblib.dump(scaler, 'src/gradientboosting/gb_scaler.pkl')  # Save the scaler
...
grid_search = GridSearchCV(estimator=gbr_model, param_grid=param_grid, scoring='neg_mean_squared_error', cv=3)
...
results_file_path = 'src/gradientboosting/gradient_model_results.json'  # Update with your desired path
...
joblib.dump(best_model, 'src/gradientboosting/gb_regressor.pkl')
