...
model = keras.models.load_model('src/mlp/mlp_model.keras')  # Replace with your model file
...
scaler = joblib.load('src/mlp/mlp_scaler.pkl')
...
new_features_df = pd.DataFrame({
    'Model Name': ["MLP"],  # Assuming SVR is the model you're using
